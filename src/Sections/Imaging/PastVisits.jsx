...
function ImagingPastVisits({ pastImagingVisits, onViewPatientInfo }) {
  const [searchTerm, setSearchTerm] = useState("");
  const [currentPage, setCurrentPage] = useState(1);
  const pageSize = 5;

  // Sort latest first
  const sorted = [...pastImagingVisits].sort(
  ...
  return (
    <div className={styles.sectionBox}>
      <h2 className={styles.sectionTitle}>Past Imaging Patients</h2>
...
export default ImagingPastVisits;
